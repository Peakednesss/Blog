...
SECRET_KEY = "django-insecure-xo)kgeq^2=gn58)oe%s*ks76b)g-9=#m^9kvnne(8%ms(ca#um"
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',  # 仅允许 JSON 响应
...
CORS_ALLOW_ALL_ORIGINS = True  # 开发环境允许所有跨域请求[6,9](@ref)
